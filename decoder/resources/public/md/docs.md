...
Two middleware functions are provided by default in the `decoder.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `decoder.handler` namespace to manage the enabled middleware.
